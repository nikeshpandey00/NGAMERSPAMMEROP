...
async def start_R4V4N():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await idk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await ydk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await wdk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await hdk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await sdk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await adk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await bdk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await cdk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await ddk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await edk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await vkk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await kkk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await lkk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await mkk(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await sid(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await shy(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await aan(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await ake(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await eel(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await khu(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await shi(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await yaa(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await dav(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await raj(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            await put(functions.channels.JoinChannelRequest(channel="@DEVILOPBOLTESUB"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
...
async def help(e):
    if e.sender_id in SMEX_USERS:
       text = "⚜️𝐂𝐌𝐃'𝐒 𝐈𝐍 NGAMER 𝐒𝐏𝐀𝐌 𝐁𝐎𝐓⚜️\n\n🔰𝐔𝐓𝐈𝐋𝐒 𝐂𝐎𝐌𝐌𝐀𝐍𝐃🔰\n.ping\n.restart\n\n🔰𝐔𝐒𝐄𝐑𝐁𝐎𝐓 𝐂𝐎𝐌𝐌𝐀𝐍𝐃🔰:\n.bio\n.join\n.leave\n.pjoin\n.pleave\n\n🔰𝐒𝐏𝐀𝐌 𝐂𝐎𝐌𝐌𝐀𝐍𝐃🔰:\n.spam\n.delayspam\n.bigspam\n.raid\nn\nFor more help regarding usage of plugins type plugins name"
       await e.reply(text, parse_mode=None, link_preview=None )


text = """

NGAMER IS START FUCKING 😁😁

print(text)
print("")
print("SMEX! NGAMER 𝐒𝐏𝐀𝐌 𝐁𝐎𝐓 Started Sucessfully.")
